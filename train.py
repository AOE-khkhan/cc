...
parser.add_argument('--model', default='model_cls',
                    help='Model name: model_cls [default: model_cls]')
...
def train():
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            eval_acc_epoch = eval_one_epoch(sess, ops, test_writer, epoch)
            ...
            if eval_acc_epoch > eval_acc_max_so_far:
                ...
                log_string_record('**** EPOCH %03d Max_RECORD ****' % (epoch), LOG_FOUT_max_record)
...
def train_one_epoch(sess, ops, train_writer):
    ...
    for fn in range(len(TRAIN_FILES)):
        ...
        for batch_idx in range(num_batches):
            ...
            batch_data = provider.scale_point_cloud(current_data[start_idx:end_idx, :, :])
